            ...
            <div class="card-body">
                ...
                <form>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="namaPelanggan" value="{{ $customer->name }}"
                                disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="noHP" value="{{ $customer->contact }}"
                                disabled>
                        </div>
                    </div>
                    <div class="row mb-3">
                ...
                <form method="GET" action="{{ route('customer.show', $customer->id) }}" class="mb-4">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control"
                            placeholder="Cari berdasarkan No Pol atau Jenis Kendaraan" value="{{ $searchTerm }}">
                ...
                <div class="table-responsive mt-3">
                    ...
                    @else
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                @foreach ($sortedVehicles as $vehicle)
                                    <tr class="text-center animate__animated animate__fadeInUp"
                                        style="animation-delay: {{ 1.2 + $loop->index * 0.1 }}s;">
                                        ...
                                        <td>
                                            <a href="{{ route('vehicle.show', $vehicle->id) }}"
                                                ...
                                                style="animation-delay: {{ 1.3 + $loop->index * 0.1 }}s;">
                                            ...
                                            <form action="{{ route('vehicle.destroy', $vehicle->id) }}" method="POST"
                                                ...
                                                <button type="submit" class="btn btn-danger rounded-pill px-4 py-2"
                                                    style="animation-delay: {{ 1.5 + $loop->index * 0.1 }}s;">
                                                    <i class="bi bi-trash"></i> Hapus
                                                </button>
                                            </form>
                                            @if (!Gate::allows('isKasir'))
                                                <a href="{{ route('service.create', ['vehicle_id' => $vehicle->id]) }}"
                                                    class="btn btn-primary rounded-pill px-4 py-2"
                                                    style="animation-delay: {{ 1.6 + $loop->index * 0.1 }}s;">
                        ...
                        <div class="d-flex justify-content-center mt-3 animate__animated animate__fadeInUp"
