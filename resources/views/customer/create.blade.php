                ...
                <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="vehicle-fields">
                        <div class="vehicle-group mb-3" id="vehicle-0">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="vehicles[0][vehicle_type]" class="form-control mb-2"
                                       ...
                                       @elseif (Auth::user()->jurusan == 'TKRO') Xenia 1.5 A/T @endif"
                                        required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="vehicles[0][license_plate]" class="form-control mb-2"
                                        value="{{ old('vehicles.0.license_plate') }}" placeholder="Masukkan nomor plat"
                                        required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="vehicles[0][production_year]" class="form-control mb-2"
                                        value="{{ old('vehicles.0.production_year') }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if (old('vehicles.0.image'))
                                        <img src="{{ asset('storage/' . old('vehicles.0.image')) }}" alt="Preview Image"
                            ...
                            <button type="button" class="btn btn-danger btn-sm mt-2" onclick="deleteVehicle(0)"><i
                                    class="fas fa-trash"></i> Hapus Kendaraan</button>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between mt-3">
                        <button type="button" id="add-vehicle" class="btn btn-secondary"><i
                                class="fas fa-plus-circle"></i> Tambah Kendaraan</button>
                        <div>
                            <button type="submit" class="btn btn-success"><i class="fas fa-save"></i> Simpan</button>
                            <a href="{{ route('customer.index') }}" class="btn btn-warning ml-2"><i
