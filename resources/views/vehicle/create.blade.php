    ...
    <div class="container mt-5">
        ...
        @if ($errors->any())
            <div class="card border-danger mb-4">
                <div class="card-header bg-danger text-white">Terjadi Kesalahan</div>
                <div class="card-body">
                    <ul>
                ...
                <form action="{{ route('vehicle.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="engine_code" name="engine_code" value="{{ old('engine_code') }}">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="license_plate" name="license_plate" value="{{ old('license_plate') }}">
                        </div>
                    </div>
