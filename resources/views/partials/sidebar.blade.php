<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav flex-column">
        <!-- Dashboard Menu Item -->
        <li
            class="nav-item {{ request()->is('/') ? 'active' : '' }} animate__animated animate__slideInLeft animate__delay-0.3s">
        ...
        @if (!Gate::allows('isBendahara'))
            <li
                class="nav-item {{ request()->is('service*') ? 'active' : '' }} animate__animated animate__slideInLeft animate__delay-3.3s">
        ...
        <li
            ...
            <div class="collapse {{ request()->is('sparepart*') ? 'show' : '' }}" id="sparepartMenu">
                <ul class="nav flex-column sub-menu">
                    <li
                        class="nav-item {{ request()->is('sparepart') ? 'active' : '' }} animate__animated animate__slideInLeft animate__delay-6.3s">
                        <a class="nav-link" href="{{ route('sparepart.index') }}">Data Sparepart</a>
                    </li>
                    @if (!Gate::allows('isSA'))
                        <li
                            class="nav-item {{ request()->is('transactions*') ? 'active' : '' }} animate__animated animate__slideInLeft animate__delay-7.8s">
        ...
        <li
            class="nav-item {{ request()->is('service.index') ? 'active' : '' }} animate__animated animate__slideInLeft animate__delay-9.3s">
        ...
        <li
            class="nav-item {{ request()->is('documentation') ? 'active' : '' }} animate__animated animate__slideInLeft animate__delay-10.8s">
