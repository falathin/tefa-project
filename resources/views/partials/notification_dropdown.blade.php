...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end navbar-dropdown shadow-lg rounded-3"
        ...
        <li class="dropdown-header px-3 py-2 border-bottom d-flex justify-content-between align-items-center">
            <p class="mb-0 fw-bold text-dark">
                ...
                Anda memiliki <strong id="newNotificationCount">{{ $jurusanNotif }}</strong> notifikasi baru
            </p>&nbsp;&nbsp;&nbsp;&nbsp;
