        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item d-none d-lg-block">
                <button class="btn btn-link nav-link" id="themeSwitchButton" onclick="toggleTheme()">
                    <i class="bi bi-moon" id="themeIcon"></i> <!-- Default icon -->
                </button>
            </li>
...
<script>
    ...
    function toggleTheme() {
        ...
        // Set new theme on the document element
        document.documentElement.setAttribute('data-bs-theme', newTheme);
        // Save theme in localStorage
        localStorage.setItem('theme', newTheme);

        // Change the theme toggle icon accordingly
        ...
        setTimeout(() => themeIcon.classList.remove('rotate'), 500); // Remove rotation after animation
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Set the initial icon based on saved theme
        let themeIcon = document.getElementById('themeIcon');
        if (savedTheme === 'dark') {
...
<style>
    /* Rotation animation for theme icon */
    .rotate {
